...
import * as fromProductEditService from "./service/productEditService";
import Snackbar from "@mui/material/Snackbar";
import MuiAlert from "@mui/material/Alert";
import * as React from "react";
import classes from "../Add-product/Add-product.module.css";
...
const EditProduct = (props) => {
  ...
  const getProductById = (productId) => {
    ...
    fromProductEditService
      .GetProductById(productId, header)
      .then((res) => {
  ...
  const onSubmitHandler = (event) => {
    ...
    fromProductEditService
      .UpdateProduct(productId,data, header)
      .then((success) => {
      ...
      <div className="row col-12 col-md-6 h-auto">
        ...
        <div className="card">
          <form className="container card-body mb-3" onSubmit={onSubmitHandler}>
            <h2 className="text-center mt-2">Edit Product</h2>
            <div className="mb-3">
                    ...
                    <div className="overlay">
                      <a className="icon" title="User Profile">
                        <button
                          ...
                          className={`${classes["top-right"]} btn btn-danger`}
                        >
                          Edit Image
                        </button>
                      </a>
